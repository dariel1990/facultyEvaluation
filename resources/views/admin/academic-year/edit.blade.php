            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <div class="flex-grow-1">
                            <p class="f-w-600 f-20 header-text-primary">Create Academic Year</p>
                ...
                <div class="card-body row ">
                    <div class="col-sm-12 col-lg-12 col-xl-12">
                        ...
                        @endif
                        {!! Form::open(array('route' => ['academic.year.update', $acad->id],'method'=>'put')) !!}
                            @csrf
                            <div class="mb-2 m-form__group">
                                <div class="input-group">
                                    <span class="input-group-text" style="width:150px">Academic Year</span>
                                    {!! Form::text('academic_year', $acad->academic_year, array('placeholder' => 'academic_year','class' => 'form-control')) !!}
                                </div>
                            </div>
                            <div class="mb-2 m-form__group">
                                <div class="input-group"><span class="input-group-text" style="width:150px">Semester</span>
                                    {!! Form::text('semester', $acad->semester, array('placeholder' => 'semester','class' => 'form-control')) !!}
                                </div>
                            </div>
